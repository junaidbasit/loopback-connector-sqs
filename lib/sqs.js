...
SqsConnector.prototype.replaceOrCreate = function replaceOrCreate(options, cb) {
  console.log('%%%%% replaceOrCreate');
  return this.create.call(this, message, options, cb);
};

SqsConnector.prototype.updateAttributes = function updateAttributes(options, cb) {
